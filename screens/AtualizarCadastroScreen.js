...
export class AtualizarCadastroScreen extends Component {
  render() {
    return (
      <React.Fragment>
        <Header
        centerComponent={{ text: 'Atualizar Cadastro', style: { color: 'white' } }}
        ...
        <View style={styles.container}>
          ...
          <View style={styles.loginForm}>
            ...
            <View style={styles.loginFormItem}>
              <TextInput secureTextEntry={true} style={styles.formInput} placeholder={'Senha Anterior'} />
            </View>
            <View style={styles.loginFormItem}>
              <TextInput secureTextEntry={true} style={styles.formInput} placeholder={'Nova Senha'} />
            </View>
            <View style={styles.loginFormItem}>
            ...
            <View style={styles.loginFormItem}>
              <TouchableOpacity style={styles.btn}>
                <Text style={{color: 'white', fontWeight: 'bold', textAlign: 'center'}}>Atualiar Cadastro</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
