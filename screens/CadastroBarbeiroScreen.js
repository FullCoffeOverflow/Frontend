...
import { ToolbarAndroid, Platform, StyleSheet, Text, View, Image, TextInput, TouchableOpacity, ActivityIndicator, ScrollView} from 'react-native';
...
export class CadastroBarbeiroScreen extends Component {
  ...
  renderButton() {
    ...
    return (
      <TouchableOpacity style={styles.btn} onPress={() => this.cadastraBarbeiro()}>
  ...
  cadastraBarbeiro() {
    ...
    return fetch('https://fullcoffeeoverflow.herokuapp.com/v01/barbeiros/cadastro', data)
            .then((response) => {
              this.setState({
                isLoading: false
              })
